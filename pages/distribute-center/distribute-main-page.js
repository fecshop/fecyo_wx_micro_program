...
Page({
  ...
  removeGoods: function(e) {
    ...
    console.log(goodsid)
    wx.request({
      url: app.globalData.urls + '/distribute/mainpage/remove',
      data: {
        goodsid: goodsid
      },
      ...
      success: function (res) {
        if (res.data.code == 200) {
          that.loadMainPageGoods()
        }
      }
    })
  },
  onShow: function () {
    this.loadMainPageGoods()
  },
  loadMainPageGoods: function () {
    var that = this;
    if (app.globalData.iphone == true) { that.setData({ iphone: 'iphone' }) }
    wx.request({
      url: app.globalData.urls + '/distribute/mainpage/index',
      data: {},
      header: app.getRequestHeader(),
      success: function (res) {
        if (res.data.code == 200) {
